...
You now have two LoRA adapters trained from the same base model:
    test001/my_planning_coach-lora_adapter
    test002/my_planning_coach-lora_adapter
...
ADAPTER1_DIR = os.path.join(_HERE, "test001", "my_planning_coach-lora_adapter")
ADAPTER2_DIR = os.path.join(_HERE, "test002", "my_planning_coach-lora_adapter")
